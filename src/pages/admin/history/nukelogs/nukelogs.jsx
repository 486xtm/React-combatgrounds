                ...
                >
                    ...
                    <div className="flex items-center">
                      ...
                      <div className="ps-3 text-left">
                        <div className="text-base font-semibold">
                          {log.player ? log.player.name : "deleted user"}
                        </div>
                      </div>
                    </div>
                  </td>
                  <td className="px-6 py-4  leading-none">
                    <div className="w-[100%] text-center">
                      {log.country ? log.country.name : "deleted country"}
                    </div>
                  </td>

                  <td className="px-6 py-4 text-center  leading-none">
                    <div className="w-[100%] hyphens-auto">{log.type}</div>
                  </td>
                  <td className="px-6 py-4 text-center  leading-none">
                    <div className="w-[100%] hyphens-auto">
                      {formattedDate(log.updatedAt)}
                    </div>
                  </td>
                </tr>
              ))}
