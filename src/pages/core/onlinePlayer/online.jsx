      ...
      <div className="flex-1 mx-5">
        ...
        <div className="border-[#FFFF00] border-[1px] w-full min-h-[500px] h-auto text-[#FFFF00] ">
          <div className="w-full flex text-center font-bold">
            <div className="w-[10%] border-[#FFFF00] border-[1px] leading-7">No</div>
            <div className="w-[30%] border-[#FFFF00] border-[1px] leading-7">Name</div>
            <div className="w-[30%] border-[#FFFF00] border-[1px] leading-7">
              Character Type
            </div>
            <div className="w-[30%] border-[#FFFF00] border-[1px] leading-7">Level</div>
          </div>
          {onlinePlayers.length == 0 ? (
            ...
            onlinePlayers.map((user, index) => (
              <div className="w-full flex text-center" key={index}>
                <div className="w-[10%] border-[#FFFF00] border-[1px] leading-7">{index+1}</div>
                <a className="w-[30%] border-[#FFFF00] border-[1px] leading-7 underline" href="#">
                  {user.name || "--"}
                </a>
                <div className="w-[30%] border-[#FFFF00] border-[1px] leading-7">
                  {user.characterType || "--"}
